package com.runtai.testproject2.view;
...
public class ProgressButton extends View {
    ...
    private int progerssButtonDuration = 200; //变形动画时间
    private int scaleAnimationDuration = 300; //缩放动画时间
    private int rotateAnimationDuration = 400; //旋转动画时间
